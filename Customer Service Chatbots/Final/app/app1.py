...
def index():
    ...
    # escalations = query_db("SELECT COUNT(*) FROM order_id", one=True)[0]
    # issues = query_db("SELECT COUNT(*) FROM order_id", one=True)[0]
...
def chatbot():
    ...
    # Extract CSV data
    csv_data = extract_csv("./db/Orders_New_query_2024_07_01.csv")
